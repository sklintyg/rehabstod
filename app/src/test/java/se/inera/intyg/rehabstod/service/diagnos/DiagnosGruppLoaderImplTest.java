...
import se.inera.intyg.rehabstod.application.diagnos.loader.DiagnosGruppLoaderImpl;
...
@ContextConfiguration(
    classes = {DiagnosGruppLoaderImpl.class, DiagnosGruppLoaderImplTest.TestConfig.class})
class DiagnosGruppLoaderImplTest {
  ...
  static class TestConfig {
    ...
    public AppProperties appProperties() {
      return new AppProperties(
          ...
          null,
          null,
          new Resources(null, null, null, null, "placeholder", null, null, 500),
          null);
    }
  }
  ...
  @Test
  void testLoadDiagnosGrupp() throws IOException {
  ...
  @Test
  void testLoadDiagnosGruppEmptyFile() throws IOException {
    ReflectionTestUtils.setField(
  ...
  @Test
  void testLoadDiagnosGruppInvaludFileThrowsException() throws IOException {
    ReflectionTestUtils.setField(
