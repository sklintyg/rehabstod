...
import se.inera.intyg.rehabstod.application.diagnos.loader.DiagnosGruppLoader;
...
class StatisticsCalculatorImplTest {
  ...
  private static final DiagnosGrupp DIAGNOS_GRUPP_UNKNOWN =
      StatisticsCalculatorImpl.NON_MATCHING_GROUP;

  @Mock DiagnosGruppLoader diagnosGruppLoader;
  ...
  void testGetSjukfallDifferentSjukskrivningsGradFemale() throws Exception {
    ...
    assertEquals(
        (float) 1 / 5 * 100, summary.getFemaleSickLeaveDegrees().get(0).getPercentage(), 0.001f);
    assertEquals(1, summary.getFemaleSickLeaveDegrees().get(1).getCount());
    assertEquals(
        (float) 1 / 5 * 100, summary.getFemaleSickLeaveDegrees().get(1).getPercentage(), 0.001f);
    assertEquals(1, summary.getFemaleSickLeaveDegrees().get(2).getCount());
    assertEquals(
        (float) 1 / 5 * 100, summary.getFemaleSickLeaveDegrees().get(2).getPercentage(), 0.001f);
    assertEquals(2, summary.getFemaleSickLeaveDegrees().get(3).getCount());
    assertEquals(
        (float) 2 / 5 * 100, summary.getFemaleSickLeaveDegrees().get(3).getPercentage(), 0.001f);
  }
  ...
  void testGetSjukfallDifferentSjukskrivningsGradMale() throws Exception {
    ...
    assertEquals(
        (float) 1 / 5 * 100, summary.getMaleSickLeaveDegrees().get(0).getPercentage(), 0.001f);
    assertEquals(1, summary.getMaleSickLeaveDegrees().get(1).getCount());
    assertEquals(
        (float) 1 / 5 * 100, summary.getMaleSickLeaveDegrees().get(1).getPercentage(), 0.001f);
    assertEquals(1, summary.getMaleSickLeaveDegrees().get(2).getCount());
    assertEquals(
        (float) 1 / 5 * 100, summary.getMaleSickLeaveDegrees().get(2).getPercentage(), 0.001f);
    assertEquals(2, summary.getMaleSickLeaveDegrees().get(3).getCount());
    assertEquals(
        (float) 2 / 5 * 100, summary.getMaleSickLeaveDegrees().get(3).getPercentage(), 0.001f);
  }
  ...
  void testSickLeaveSummaryWhenSickLeaveHasSeveralSickLeaveDegrees() throws Exception {
    ...
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId1, lakareNamn1, Gender.F, "M16", 25, Arrays.asList(25, 50, 75, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId1, lakareNamn1, Gender.F, "M16", 25, Arrays.asList(25, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.F, "M16", 50, Arrays.asList(25, 50, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 75, Arrays.asList(25, 50, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 100, Arrays.asList(25, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100)));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100)));
    ...
    assertEquals(
        (float) 2 / 7 * 100, summary.getCountSickLeaveDegrees().get(0).getPercentage(), 0.001f);
    assertEquals(5, summary.getCountSickLeaveDegrees().get(1).getCount());
    assertEquals(
        (float) 5 / 7 * 100, summary.getCountSickLeaveDegrees().get(1).getPercentage(), 0.001f);
  }
  ...
  void testSickLeaveSummaryWhenSickLeaveHasSeveralSickLeaveDegreesForMales() throws Exception {
    ...
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId1, lakareNamn1, Gender.M, "M16", 25, Arrays.asList(25, 50, 75, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId1, lakareNamn1, Gender.F, "M16", 25, Arrays.asList(25, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 50, Arrays.asList(25, 50, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 75, Arrays.asList(25, 50, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 100, Arrays.asList(25, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.M, "M16", 100, List.of(100)));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100)));
    ...
    assertEquals(
        (float) 1 / 5 * 100, summary.getCountMaleSickLeaveDegrees().get(0).getPercentage(), 0.001f);
    assertEquals(4, summary.getCountMaleSickLeaveDegrees().get(1).getCount());
    assertEquals(
        (float) 4 / 5 * 100, summary.getCountMaleSickLeaveDegrees().get(1).getPercentage(), 0.001f);
  }
  ...
  void testSickLeaveSummaryWhenSickLeaveHasSeveralSickLeaveDegreesForFemales() throws Exception {
    ...
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId1, lakareNamn1, Gender.M, "M16", 25, Arrays.asList(25, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.F, "M16", 50, Arrays.asList(25, 50, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.F, "M16", 75, Arrays.asList(25, 50, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.F, "M16", 100, Arrays.asList(25, 100)));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100)));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.M, "M16", 100, List.of(100)));
    ...
    assertEquals(
        (float) 1 / 5 * 100,
        summary.getCountFemaleSickLeaveDegrees().get(0).getPercentage(),
        0.001f);
    assertEquals(4, summary.getCountFemaleSickLeaveDegrees().get(1).getCount());
    assertEquals(
        (float) 4 / 5 * 100,
        summary.getCountFemaleSickLeaveDegrees().get(1).getPercentage(),
        0.001f);
  }
  ...
  void testSickLeaveSummarySickLeaveLength() throws Exception {
    ...
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId1, lakareNamn1, Gender.F, "M16", 25, Arrays.asList(25, 50, 75, 100), 10));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId1, lakareNamn1, Gender.F, "M16", 25, Arrays.asList(25, 100), 90));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.F, "M16", 50, Arrays.asList(25, 50, 100), 91));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 75, Arrays.asList(25, 50, 100), 180));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 100, Arrays.asList(25, 100), 181));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100), 365));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100), 400));
  ...
  void testSickLeaveSummarySickLeaveLengthMale() throws Exception {
    ...
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId1, lakareNamn1, Gender.M, "M16", 25, Arrays.asList(25, 50, 75, 100), 10));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId1, lakareNamn1, Gender.M, "M16", 25, Arrays.asList(25, 100), 90));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 50, Arrays.asList(25, 50, 100), 91));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 75, Arrays.asList(25, 50, 100), 180));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.M, "M16", 100, Arrays.asList(25, 100), 181));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.M, "M16", 100, List.of(100), 365));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.M, "M16", 100, List.of(100), 400));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100), 400));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100), 400));
    ...
    assertEquals(
        (float) 1 / 7 * 100, summary.getMaleSickLeaveLengths().get(0).getPercentage(), 0.001f);
    assertEquals(3, summary.getMaleSickLeaveLengths().get(1).getCount());
    assertEquals(
        (float) 3 / 7 * 100, summary.getMaleSickLeaveLengths().get(1).getPercentage(), 0.001f);
    assertEquals(2, summary.getMaleSickLeaveLengths().get(2).getCount());
    assertEquals(
        (float) 2 / 7 * 100, summary.getMaleSickLeaveLengths().get(2).getPercentage(), 0.001f);
    assertEquals(1, summary.getMaleSickLeaveLengths().get(3).getCount());
    assertEquals(
        (float) 1 / 7 * 100, summary.getMaleSickLeaveLengths().get(3).getPercentage(), 0.001f);
  }
  ...
  void testSickLeaveSummarySickLeaveLengthFemale() throws Exception {
    ...
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.F, "M16", 75, Arrays.asList(25, 50, 100), 180));
    internalSjukfallList.add(
        createInternalSjukfall(
            lakareId2, lakareNamn2, Gender.F, "M16", 100, Arrays.asList(25, 100), 181));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100), 365));
    internalSjukfallList.add(
        createInternalSjukfall(lakareId2, lakareNamn2, Gender.F, "M16", 100, List.of(100), 400));
    ...
    assertEquals(
        (float) 1 / 7 * 100, summary.getFemaleSickLeaveLengths().get(0).getPercentage(), 0.001f);
    assertEquals(3, summary.getFemaleSickLeaveLengths().get(1).getCount());
    assertEquals(
        (float) 3 / 7 * 100, summary.getFemaleSickLeaveLengths().get(1).getPercentage(), 0.001f);
    assertEquals(2, summary.getFemaleSickLeaveLengths().get(2).getCount());
    assertEquals(
        (float) 2 / 7 * 100, summary.getFemaleSickLeaveLengths().get(2).getPercentage(), 0.001f);
    assertEquals(1, summary.getFemaleSickLeaveLengths().get(3).getCount());
    assertEquals(
        (float) 1 / 7 * 100, summary.getFemaleSickLeaveLengths().get(3).getPercentage(), 0.001f);
  }
  ...
  void testGetSickLeaveSummaryDiagnosisGroupsForMale() throws Exception {
    ...
    assertEquals(
        (float) 3 / 6 * 100, summary.getMaleDiagnosisGroups().get(0).getPercentage(), 0.001f);
    assertEquals(
        (float) 2 / 6 * 100, summary.getMaleDiagnosisGroups().get(1).getPercentage(), 0.001f);
    assertEquals(
        (float) 1 / 6 * 100, summary.getMaleDiagnosisGroups().get(2).getPercentage(), 0.001f);
  }
  ...
  void testGetSickLeaveSummaryDiagnosisGroupsForFemale() throws Exception {
    ...
    assertEquals(
        (float) 3 / 6 * 100, summary.getFemaleDiagnosisGroups().get(0).getPercentage(), 0.001f);
    assertEquals(
        (float) 2 / 6 * 100, summary.getFemaleDiagnosisGroups().get(1).getPercentage(), 0.001f);
    assertEquals(
        (float) 1 / 6 * 100, summary.getFemaleDiagnosisGroups().get(2).getPercentage(), 0.001f);
  }
  ...
  private SjukfallEnhet createInternalSjukfall(
      String lakareId, String lakareNamn, Gender patientKon, String diagnosKod, int aktivGrad) {
  ...
  private SjukfallEnhet createInternalSjukfall(
      String lakareId, String lakareNamn, Gender patientKon, String diagnosKod) {
