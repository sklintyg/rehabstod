...
class UnansweredCommunicationFilteringServiceTest {
  ...
  @InjectMocks UnansweredCommunicationFilterServiceImpl unansweredCommunicationFilterService;
    ...
    class TestNonMatchingFilterTypeId {
      ...
      void shouldThrowIllegalArgumentException() {
        ...
        assertThrows(
            ...
            () -> unansweredCommunicationFilterService.filter(sickLeaves, "random"));
      }
    }
