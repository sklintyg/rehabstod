 ...
 */
package se.inera.intyg.rehabstod.application.config;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.mockito.Mockito.doReturn;
import static se.inera.intyg.rehabstod.application.config.ConfigController.PROJECT_VERSION_PROPERTY;
import static se.inera.intyg.rehabstod.application.config.ConfigController.SITHS_IDP_URL;
import static se.inera.intyg.rehabstod.application.config.ConfigController.WEBCERT_LAUNCH_URL_TEMPLATE;
