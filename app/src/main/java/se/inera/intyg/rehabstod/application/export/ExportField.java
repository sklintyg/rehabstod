...
public enum ExportField {
  ...
  private static void addFieldIfItExists(
      EnumSet<ExportField> allFields, List<ExportField> enabledFields, String jsonString) {
  ...
  public static Optional<ExportField> fromJsonId(String jsonId) {
    ...
    return allFields.stream().filter(ef -> ef.getJsonId().equalsIgnoreCase(jsonId)).findAny();
  }
