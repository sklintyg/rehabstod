 ...
 */
package se.inera.intyg.rehabstod.infrastructure.security.common.model;
...
public class IntygUser implements UserDetails {
   ...
   * </ul>
   *
   * <p>Note: This construct smells a bit, as it's somewhat ambigous what isLakare could be
   * interpreted as?
   *
