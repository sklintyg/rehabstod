 ...
 */
package se.inera.intyg.rehabstod.application.export;
...
public abstract class BaseExportService {
  ...
  protected static final String FILTER_TITLE_ARENDESTATUS_UTAN =
      "Visa enbart sjukfall utan obesvarade ärenden";
  protected static final String FILTER_TITLE_ARENDESTATUS_MED =
      "Visa enbart sjukfall med obesvarade ärenden";
  protected static final String FILTER_TITLE_ARENDESTATUS_MED_KOMPLETTERING =
      "Visa sjukfall med obesvarade kompletteringar";
  protected static final String FILTER_TITLE_ARENDESTATUS_MED_FRAGOR =
      "Visa sjukfall med obesvarade administrativa frågor och svar";
  ...
  protected boolean shouldShowSortering(
      PrintSjukfallRequest req, List<ExportField> displayedFields) {
