 ...
 */
package se.inera.intyg.rehabstod.infrastructure.integration.srs.service;
...
public interface SRSIntegrationService {
   ...
   * se.inera.intyg.rehabstod.infrastructure.integration.srs.client.SRSClientService} where the
   * native response type {@link
