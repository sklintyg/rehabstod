 ...
 */
package se.inera.intyg.rehabstod.application.diagnos.converter;
...
public class IcdCodeConverter {
  ...
  public Map<String, String> convert(String file) throws IOException {
    ...
    final var diagnosisMap =
        getStream(resource)
            ...
            .collect(Collectors.toMap(DiagnosKod::getCode, DiagnosKod::getName));
  ...
  private DiagnosKod toDiagnosis(String line) {
    ...
    return new DiagnosKod(text[DIAGNOSIS_CODE_INDEX].replace(".", ""), text[DIAGNOSIS_TITLE_INDEX]);
  }
