 ...
 */
package se.inera.intyg.rehabstod.infrastructure.logging.logmessages;
...
/**
 * Class for all log messages. Each project sending PDL log messages should implement their own
