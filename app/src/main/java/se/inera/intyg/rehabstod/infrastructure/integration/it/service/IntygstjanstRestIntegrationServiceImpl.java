...
import se.inera.intyg.rehabstod.infrastructure.integration.it.dto.PopulateFiltersResponseDTO;
...
public class IntygstjanstRestIntegrationServiceImpl implements IntygstjanstRestIntegrationService {
  ...
  @Override
  @PerformanceLogging(
      eventAction = "get-diagnosed-certificates-for-care-unit",
      eventType = MdcLogConstants.EVENT_TYPE_ACCESSED)
  public List<DiagnosedCertificate> getDiagnosedCertificatesForCareUnit(
      List<String> units,
    ...
    final var requestObject =
        getTypedCertificateRequest(units, certificateTypes, fromDate, toDate, null);
  ...
  @Override
  @PerformanceLogging(
      eventAction = "get-diagnosed-certificates-for-person",
      eventType = MdcLogConstants.EVENT_TYPE_ACCESSED)
  public List<DiagnosedCertificate> getDiagnosedCertificatesForPerson(
  ...
  public List<DiagnosedCertificate> getDiagnosedCertificatesForPerson(
    ...
    final var requestObject =
        getTypedCertificateRequest(units, certificateTypes, fromDate, toDate, personId);
  ...
  @Override
  @PerformanceLogging(
      eventAction = "get-sick-leave-certificates-for-person",
      eventType = MdcLogConstants.EVENT_TYPE_ACCESSED)
  public List<SickLeaveCertificate> getSickLeaveCertificatesForPerson(
      String personId, List<String> certificateTypes, List<String> units, List<String> doctorIds) {
    return getSickLeaveCertificatesForPerson(
        personId, certificateTypes, null, null, units, doctorIds);
  }
  ...
  @Override
  @PerformanceLogging(
      eventAction = "get-signing-doctors-for-unit",
      eventType = MdcLogConstants.EVENT_TYPE_ACCESSED)
  ...
  @Override
  @PerformanceLogging(
      eventAction = "get-active-sick-leaves",
      eventType = MdcLogConstants.EVENT_TYPE_ACCESSED)
  ...
  @Override
  @PerformanceLogging(
      eventAction = "get-populated-filers-for-active-sick-leaves",
      eventType = MdcLogConstants.EVENT_TYPE_ACCESSED)
  public PopulateFiltersResponseDTO getPopulatedFiltersForActiveSickLeaves(
  ...
  private TypedCertificateRequest getTypedCertificateRequest(
      List<String> units,
      List<String> certificateTypes,
      LocalDate fromDate,
      LocalDate toDate,
