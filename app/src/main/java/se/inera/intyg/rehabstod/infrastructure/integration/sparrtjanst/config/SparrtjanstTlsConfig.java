...
import se.inera.intyg.rehabstod.infrastructure.integration.sparrtjanst.config.properties.NtjpProperties;
...
public class SparrtjanstTlsConfig {
  ...
  public SparrtjanstTlsConfig(NtjpProperties ntjpProperties) {
