 ...
 */
package se.inera.intyg.rehabstod.integration.intygproxyservice.client;

import static org.junit.jupiter.api.Assertions.assertEquals;
import static org.mockito.Mockito.doReturn;
import static org.mockito.Mockito.mock;
import static org.mockito.Mockito.verify;
import static se.inera.intyg.rehabstod.pu.integration.intygproxyservice.configuration.PURestClientConfig.LOG_SESSION_ID_HEADER;
import static se.inera.intyg.rehabstod.pu.integration.intygproxyservice.configuration.PURestClientConfig.LOG_TRACE_ID_HEADER;
import static se.inera.intyg.rehabstod.pu.integration.intygproxyservice.configuration.PURestClientConfig.SESSION_ID_KEY;
import static se.inera.intyg.rehabstod.pu.integration.intygproxyservice.configuration.PURestClientConfig.TRACE_ID_KEY;
...
import se.inera.intyg.rehabstod.pu.integration.intygproxyservice.client.GetPersonsIntygProxyServiceClient;
...
import se.inera.intyg.rehabstod.pu.integration.intygproxyservice.dto.PersonsRequestDTO;
import se.inera.intyg.rehabstod.pu.integration.intygproxyservice.dto.PersonsResponseDTO;
...
class GetPersonsIntygProxyServiceClientTest {
  ...
  @BeforeEach
  void setUp() {
    getPersonsIntygProxyServiceClient = new GetPersonsIntygProxyServiceClient(
        restClient, new PuIntygProxyServiceProperties(null, null, ENDPOINT));
