...
import se.inera.intyg.rehabstod.hsa.stub.BootstrapBean;
import se.inera.intyg.rehabstod.hsa.stub.HsaServiceStub;
import se.inera.intyg.rehabstod.hsa.stub.HsaWebServiceStub;

import com.fasterxml.jackson.databind.ObjectMapper;

@Configuration
@ComponentScan({"se.inera.intyg.rehabstod.common.config"})
