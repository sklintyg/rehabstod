...
public class PUServiceTest {
    ...
    public void checkCachedPerson() throws Exception {
        ...
        ReflectionTestUtils.setField(((Advised) service).getTargetSource().getTarget(), "puWebServiceClient", mockResidentService);
        ...
        ReflectionTestUtils.setField(((Advised)service).getTargetSource().getTarget(), "puWebServiceClient", residentService);
    }
