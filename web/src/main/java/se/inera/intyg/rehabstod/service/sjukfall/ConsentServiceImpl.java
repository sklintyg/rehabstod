...
public class ConsentServiceImpl implements ConsentService {
    ...
    @Override
    public List<IntygData> getIntygDataForPatient(String currentVardgivarHsaId, String enhetsId, String lakareId, String patientId, Urval urval, IntygParametrar parameters) {
