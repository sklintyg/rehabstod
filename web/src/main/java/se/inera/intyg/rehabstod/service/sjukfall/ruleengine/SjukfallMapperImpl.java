 ...
 */
@Component
public class SjukfallMapperImpl implements SjukfallMapper {

    private static final Logger LOG = LoggerFactory.getLogger(SjukfallMapperImpl.class);
