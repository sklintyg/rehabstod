...
var rhsMessages = {
    'sv': {
        ...
        'modal.pdlconsent.rehabkoordinator.body': '<b>Viktigt!</b><br><br>Väljer du att gå vidare kommer du få se alla pågående sjukfall för den enhet du har loggat in på. För varje sjukfall visas patientens personuppgifter, diagnos, sjukskrivningstid, sjukskrivningsgrad och läkare.<br><br>Om du väljer att visa ett intyg kopplat till ett sjukfall kommer intyget öppnas i Webcert. Informationen som kommer visas loggas enligt Patientdatalagen (PDL) (för mer information om loggning gå till "Om Rehabstöd" i menyn). Visning av intyg PDL-loggas i Webcert.<br><br>Genom att klicka i "Jag förstår och godkänner" tar du ställning till att det är nödvändigt för dig att i din yrkesroll få ta del av patienternas uppgifter samt bekräftar din kännedom om den loggning som sker. Detta godkännande gäller för alla enheter som du har behörighet till.<br><br>Detta godkännande kommer endast krävas en gång.',
        'modal.pdlconsent.lakare.body': '<b>Viktigt!</b><br><br>Väljer du att gå vidare kommer du få se dina pågående sjukfall för den enhet du har loggat in på. För varje sjukfall visas patientens personuppgifter, diagnos, sjukskrivningstid och sjukskrivningsgrad.<br><br>Om du väljer att visa ett intyg kopplat till ett sjukfall kommer intyget öppnas i Webcert.<br><br>Informationen som kommer visas loggas enligt Patientdatalagen (PDL) (för mer information om loggning gå till "Om Rehabstöd" i menyn). Visning av intyg PDL-loggas i Webcert.<br><br>Genom att klicka i "Jag förstår och godkänner" tar du ställning till att det är nödvändigt för dig att i din yrkesroll få ta del av patienternas uppgifter samt bekräftar din kännedom om den loggning som sker. Detta godkännande gäller för alla enheter som du har behörighet till. <br><br>Detta godkännande kommer endast krävas en gång.',
