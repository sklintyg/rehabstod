...
var rhsMessages = {
    'sv': {
        ...
        'label.table.column.sort.patient.id': 'Personnummer',
        'label.table.column.patientname': 'Namn',
        'label.table.column.sort.patient.namn': 'Namn',
        'label.table.column.patientage': 'Ålder',
        'label.table.column.sort.patient.alder': 'Ålder',
        'label.table.column.gender': 'Kön',
        'label.table.column.sort.patient.konshow': 'Kön',
        'label.table.column.dxs': 'Diagnos/diagnoser',
        'label.table.column.sort.diagnos.intygsvarde': 'Diagnos(er)',
        ...
        'label.table.column.sort.start': 'Startdatum',
        ...
        'label.table.column.sort.slut': 'Slutdatum',
        'label.table.column.degree': 'Grad',
        'label.table.column.sort.aktivgrad': 'Grad',
        ...
        'label.table.column.kompletteringar': 'Komplettering',
        'label.table.column.sort.obesvaradekompl': 'Komplettering',
        'label.table.column.kompletteringar.help': 'Visar om det finns intyg i sjukfallet som har obesvarade kompletteringsbegäran och hur många det är.',
        'label.table.column.doctor': 'Läkare',
        'label.table.column.sort.lakare.namn': 'Läkare',
        ...
        'label.table.column.sort.dagar': 'Längd',
        ...
        'label.table.column.sort.intyg': 'Antal intyg',
        'label.table.column.antal.help': 'Antalet intyg som ingår i sjukfallet.',
        'label.table.column.srs': 'Risk',
        'label.table.column.sort.risksignal.riskkategori': 'Risk',
