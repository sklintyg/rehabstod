...
var rhsMessages = {
    'sv': {
        ...
        'label.table.column.bidiagnoser': 'Bidiagnoser',
        'label.table.column.bidiagnoser.help': 'Bidiagnos(er) i nuvarande intyg. För muspekaren över koden för att se vilken diagnos den motsvarar.',
